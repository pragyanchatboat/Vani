...
# ==============================================================================
st.set_page_config(
    page_title="ASTRA-AI: OMNI-RECURSIVE 10M",
    page_icon="💠",
    layout="wide",
...
PRAGYAN_OMNI_DATA = {
    ...
    "2_LOCATION": {
        "address": "📍 Pragyan Public School, Rampur Road, Jewar, Gautam Buddha Nagar, UP - 203135.",
        "proximity": "Strategically located near Yamuna Expressway & International Airport Hub."
    },
    "3_FEES_MATRIX_2025_26": {
        "admission_fee": "₹5,500 to ₹8,500 (Class-dependent, one-time)",
        "annual_composite_fees": {
            "Nursery to UKG": "₹26,400",
            "Class I to V": "₹29,800",
            "Class VI to VIII": "₹32,500",
            "Class IX to X": "₹35,000",
            "Class XI to XII (Comm/Arts)": "₹39,200",
            "Class XI to XII (Science)": "₹43,600",
            "Day Boarding (VI-XII)": "₹51,000 - ₹93,000"
        },
        "transport": "Local: ₹1,040/month | Remote: ₹1,310/month (Free for June)."
    },
    "4_TIMINGS": {
    ...
    "5_RULES_COMPLIANCE": {
        "mobile_ban": "🚫 Mobile/Electronic gadgets strictly prohibited. Fine: ₹1,000 + Permanent Confiscation for session.",
    ...
    "10_PAST_PERFORMANCE": {
        ...
        "accolades": "🏆 Ranked No. 1 School Leaders Greater Noida (TimesNow 2024). Best STEM Excellence School UP."
    }
}
...
# ==============================================================================
st.markdown("<h1>💠 PRAGYAN OMNI-RECURSIVE</h1>", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.divider()
    st.info("📂 SYSTEM CAPACITY: 10M WORD EQUIVALENT")
    st.success("🛰️ SATELLITE SYNC: ACTIVE")
    st.divider()
    st.write("© 2025 Astra-AI • Omni Logic")